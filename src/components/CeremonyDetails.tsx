        ...
        <div className="lg:w-1/2 w-full relative mt-16 lg:mt-0">
          ...
          >
            ...
            <div className="relative aspect-[3/4] sm:aspect-[4/5] rounded-[2rem] sm:rounded-[3rem] overflow-hidden border-[6px] sm:border-[8px] border-white shadow-[0_20px_50px_rgba(70,130,180,0.2)] bg-brand-champagne group">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-black/5 pointer-events-none mix-blend-overlay opacity-70 group-hover:opacity-100 transition-opacity duration-1000" />
            </div>
